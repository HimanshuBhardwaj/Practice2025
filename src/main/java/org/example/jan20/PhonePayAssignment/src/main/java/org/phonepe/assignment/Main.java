...
public class Main {
    ...
    static void stockModifyOrder_Success() {
        ...
        Order order1 = new Order(UUID.fromString("d9d30604-9400-4b2b-a4cd-1b4fd8436c60"), UUID.fromString("c9d30604-9400-4b2b-a4cd-1b4fd8436c60"), OrderType.BUY, StockSymbol.FLIPKART, 2, 10);
        Order order6 = new Order(UUID.fromString("d9d30604-9400-4b2b-a4cd-1b4fd8436c65"), UUID.fromString("c9d30604-9400-4b2b-a4cd-1b4fd8436c60"), OrderType.BUY, StockSymbol.FLIPKART, 2, 100);

        exchangeService.modifyOrder(order1);
        exchangeService.modifyOrder(order6);
